...
<head>
    ...
    <title>Home - SpeedHomes</title>

    <script src="../cdn-cgi/apps/head/2oc_RD5SS6wgN5SiQnSEnWVNHg8.js"></script><link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&amp;family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&amp;display=swap" rel="stylesheet">
    ...
    <meta name="twitter:title" content="Home 06">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">

    <meta property="og:url" content="home-06.html">
    ...
    <style>
        ...
        #loader::after {
            box-shadow: 18px 18px red, -18px -18px #f4a261;
    ...
    <div class="sticky-area">
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-transparent px-0">
                <a class="navbar-brand px-0 mr-auto" href="index.html">
                    <img src="{{asset('web/images/logo.png')}}" class="normal-logo" alt="HomeID">

                    <img src="{{asset('web/images/logo.png')}}" alt="HomeID" class="sticky-logo"> Speed Homes
...
<main id="content">
    <section class="d-flex flex-column">
        <div class="bg-cover d-flex align-items-center custom-vh-100" style="background-image: url({{asset('web/images/bg-home-6.jpg')}})">
            <div class="container py-8 py-lg-12">
                <div class="card border-0 mxw-470 mx-auto mr-md-0 my-lg-3" data-animate="fadeInDown">
                    <div class="card-body pt-7 pb-6 px-7 shadow-lg-4">
                        ...
                        <p class="card-text text-center">To help you find your property</p>
                        <form method="post" action="{{ route('contact') }}">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-2">
                                    <input type="text" class="form-control form-control-lg border-0 shadow-none" name="name" placeholder="Name">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <div class="input-group">
                                        <input type="tel" class="form-control form-control-lg border-0 shadow-none" name="phone" aria-label="Text input with dropdown button" placeholder="Phone">
                                    </div>
                                </div>
                                <div class="col-md-12 mb-2">
                                    <input type="email" class="form-control form-control-lg border-0 shadow-none" placeholder="Email" name="email">
                                </div>
                                <div class="col-md-12 mb-4">
                                    <textarea name="content" class="form-control form-control-lg border-0 shadow-none h-140" placeholder="How is your desired property?"></textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <button type="submit" class="btn btn-primary btn-lg btn-block shadow-none">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <section class="pt-9 pt-lg-1 pb-9 pb-lg-11">
        <div class="container">
                    ...
                    <div class="box py-1">
                        <div class="card" data-animate="fadeInUp">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="{{ asset('uploads/'.$property->randomFile()['file_name']) }}" alt="Home in Metric Way" style="width: 100%; height: 100%">
                                <div class="card-img-overlay p-2 d-flex flex-column">
                                    <div class="mt-auto d-flex hover-image">
                                        <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                                            <li class="list-inline-item mr-2" data-toggle="tooltip" title="9 Images">
                                                <a href="{{ route('property.view', ['property' => $property->id]) }}" class="text-white hover-primary">
                                                    <i class="far fa-images"></i><span class="pl-1">{{ $property->files()->count() }}</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <ul class="list-inline mb-0 d-flex align-items-end mr-n3">
                                            ...
                                            <li class="list-inline-item mr-3 h-32" data-toggle="tooltip" title="Compare">
                                                <a href="{{ route('property.view', ['property' => $property->id]) }}" class="text-white fs-20 hover-primary">
                            ...
                            <div class="card-header bg-transparent d-flex justify-content-between align-items-center py-3">
                                <p class="fs-17 font-weight-bold text-heading mb-0 lh-1">₦{{ number_format($property->price) }}</p>
                            ...
                            <div class="card-body py-2">
                                <h2 class="fs-16 lh-2 mb-0"><a href="{{ route('property.view', ['property' => $property->id]) }}" class="text-dark hover-primary">{{ $property->title }}</a>
                                </h2>
                                <p class="font-weight-500 text-gray-light mb-0">{{ $property->address }}</p>
                            </div>
                            <div class="card-footer bg-transparent pt-3 pb-4">
                                <ul class="list-inline d-flex justify-content-between mb-0 flex-wrap mr-n2">
                                    ...
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-2" data-toggle="tooltip" title="1 Garage">
            ...
            <div class="row mt-7 justify-content-between">
                <div class="col-lg-4 mb-6 mb-lg-0">
                    <div class="card border-0 bg-transparent" data-animate="fadeInUp">
                        <div class="d-flex align-items-end justify-content-center card-img-top">
                            <img src="{{asset('web/images/urban.png')}}" alt="Wider range of properties">
                        </div>
                        <div class="card-body px-3 pt-6 text-center">
    ...
    <section class="pt-9 pb-9 pb-lg-11">
        <div class="container">
            ...
            <span class="heading-divider mx-auto"></span>
            <div class="slick-slider custom-arrow-spacing-30" data-slick-options='{"slidesToShow": 2, "autoplay":true,"dots":true,"rows":2,"arrows":false,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":2,"arrows":false}},{"breakpoint": 992,"settings": {"slidesToShow": 2,"arrows":false,"autoplay":true}},{"breakpoint": 768,"settings": {"slidesToShow": 2,"autoplay":true,"arrows":false}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"autoplay":true}}]}'>
                @foreach($properties as $property)
                    <div class="card border-0 bg-overlay-gradient-3 rounded-lg mt-5" data-animate="zoomIn">
                        <img src="{{ asset('uploads/'.$property->files()->first()->file_name) }}" class="card-img" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column position-relative-sm">
                            <div class="d-flex">
                                ...
                                <ul class="list-inline mb-0 pr-2">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="{{ route('property.view', ['property' => $property->id]) }}" class="w-40px h-40 rounded-circle d-inline-flex align-items-center justify-content-center text-white bg-dark-opacity-03 bg-hover-primary hover-white" data-toggle="tooltip" title="View">
                                            <i class="fas fa-exchange-alt"></i>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="mt-auto p-2">
                                <h2 class="my-0 lh-1"><a href="{{ route('property.view', ['property' => $property->id]) }}" class="fs-20 text-white">{{ $property->title }}</a></h2>
                                <p class="mb-2 text-white">{{ $property->address }}</p>
                                <div class="d-lg-flex justify-content-lg-between border-top border-white-opacity-03 pt-2">
                                    <p class="fs-22 font-weight-bold text-white lh-1 mb-0">₦{{ number_format($property->price) }}<span class="fs-18 font-weight-500"> / month</span></p>
    ...
    <section class="pt-11 pb-9 pb-md-11">
        <div class="container">
            <p class="text-primary font-weight-500 letter-spacing-263 text-center text-uppercase mb-5">Featured
                Properties</p>
            <h2 class="text-dark text-center mb-8 pb-lg-1">Check Out Our Featured Items</h2>
                    ...
                    <div class="box px-0" data-animate="fadeInUp">
                        <div class="media d-flex flex-column flex-md-row align-items-md-center py-lg-8 position-relative cusstom-bg-slider-gray no-gutters">
                            <div class="mr-lg-10 mr-md-6 card border-0 col-md-6">
                                <img src="{{ asset('uploads/'.$property->randomFile()['file_name']) }}" class="card-img" alt="Villa in Coral Gables">
                            ...
                            <div class="media-body mt-3 mt-lg-0 pr-lg-9">
                                <h2 class="my-0"><a href="{{ route('property.view', ['property' => $property->id]) }}" class="fs-26 lh-2 text-dark hover-primary">{{ $property->title }}</a></h2>
                                <p class="mb-2 fs-16 font-weight-500 text-gray-light lh-1">{{ $property->address }}</p>
                                <p class="mb-2 ml-0 pr-lg-3">{{ $property->description }}</p>
                                <ul class="row list-inline mb-0 py-3">
                                    <li class="col-sm-6">
                                        <p class="mb-0 text-gray font-weight-500 fs-13 mb-3 d-inline-block" data-toggle="tooltip" title="3 Bedrooms">
                                    ...
                                    <li class="col-sm-6">
                                        <p class="mb-0 text-gray font-weight-500 fs-13 mb-3 d-inline-block" data-toggle="tooltip" title="3 Bathrooms">
                                    ...
                                    <li class="col-sm-6">
                                        <p class="mb-0 text-gray font-weight-500 fs-13 mb-3 d-inline-block" data-toggle="tooltip" title="Size">
                                    ...
                                    <li class="col-sm-6">
                                        <p class="mb-0 text-gray font-weight-500 fs-13 mb-3 d-inline-block" data-toggle="tooltip" title="1 Garage">
                                            <svg class="icon icon-Garage fs-24 text-primary mr-2">
                                                <use xlink:href="#icon-Garage"></use>
                                            </svg>
                                ...
                                <div class="d-flex justify-content-between pt-5 border-top">
                                    <p class="fs-20 font-weight-bold text-heading mb-1">₦{{ number_format($property->price) }}</p>
                                    <ul class="list-inline mb-0 d-flex justify-content-end align-items-end h-100 hover-image mr-n5">

                                        <li class="list-inline-item mr-5" data-toggle="tooltip" title="View Property">
                                            <a href="{{ route('property.view', ['property' => $property->id]) }}" class="text-body fs-20 hover-primary">
                                                <i class="fas fa-exchange-alt"></i>
                                            </a>
                                        </li>
                                    </ul>
    ...
    <section class="pt-11 pb-13 bg-cover" style="background-image: url({{asset('web/images/bg-mailchimp-01.jpg')}})">
        <div class="container">
            <form class="text-center" data-animate="fadeInUp">
                ...
                <div class="input-group input-group-lg mt-9 mxw-571">
                    <input type="text" class="form-control bg-white shadow-none border-0 z-index-1" placeholder="Email" name="email">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                <a class="d-block mb-2" href="#">
                    <img src="{{asset('web/images/logo.png')}}" alt="Speed Homes">
                </a>
                <div class="lh-26 font-weight-500">
                    ...
                    <a class="d-block text-gray-light font-weight-bold hover-primary fs-15" href="tel:(+68)122109876">(+68)1221
                        09876</a>
                    <a class="d-block text-gray-light hover-primary" href="www.speedhomes.com">www.speedhomes.com</a>
                </div>
            </div>
        </div>
        <div class="mt-0 mt-md-10 row">
            ...
            <p class="col-md-auto mt-4 mt-md-0">
                © {{ now()->year }} SpeedHomes Consultancy. All Rights Reserved
            </p>
        </div>
    </div>
</footer>
<div class="modal fade login-register login-register-modal" id="login-register-modal" tabindex="-1" role="dialog" aria-labelledby="login-register-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mxw-571" role="document">
        <div class="modal-content" style="box-shadow: none; border: none">
            ...
            <div id="loader_container" style="position: fixed; top: 50%; left: 50%">
                <div id="loader"></div>
            </div>
        </div>
        <strong style="text-align: left;margin-top: 50px; color: white; margin-left: -230px">Loading...</strong>
