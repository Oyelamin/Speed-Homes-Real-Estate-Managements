...
<head>
    ...
    <title>Single Property 3 - HomeID</title>
    ...
    <meta name="twitter:title" content="Single Property 3">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">

    <meta property="og:url" content="single-property-3.html">
    <meta property="og:title" content="Single Property 3">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg px-0">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img src="{{asset('web/images/logo.png')}}" alt="HomeID" class="d-none d-lg-inline-block">
                    <img src="{{asset('web/images/logo-white.png')}}" alt="HomeID" class="d-inline-block d-lg-none">
                    Speed Homes
                </a>
                            ...
                            <div class="card-body px-6 py-4 text-center">
                                ...
                                <form method="post" action="{{ route('contact') }}">
                                    ...
                                    @csrf
                                        ...
                                        <input name="property" value="{{ $property->id }}" hidden>
                                    <div class="form-group mb-2">
                                        <label for="name" class="sr-only">Name</label>
                                        <input type="text" name="name" class="form-control form-control-lg border-0 shadow-none" id="name" placeholder="First Name, Last Name">
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="email" class="sr-only">Email</label>
                                        <input type="text" name="email" class="form-control form-control-lg border-0 shadow-none" id="email" placeholder="Your email">
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="phone" class="sr-only">Phone</label>
                                        <input type="text" name="phone" class="form-control form-control-lg border-0 shadow-none" id="phone" placeholder="Your phone">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="message" class="sr-only">Message</label>
                                        <textarea name="content" class="form-control border-0 shadow-none" id="message"></textarea>
                                    </div>
...
<footer class="pt-8 pb-6 footer text-gray-light bg-dark">
    <div class="container">
        <div class="row">
