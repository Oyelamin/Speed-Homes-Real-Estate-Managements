...
{{--                    <img src="{{asset('web/images/logo-white.png')}}" alt="HomeID" class="d-inline-block d-lg-none">--}}
                ...
                <div class="d-none d-lg-block">
                    <ul class="navbar-nav flex-row justify-content-lg-end d-flex flex-wrap text-body py-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  px-2" data-toggle="modal" href="{{ route('login') }}">SIGN IN</a>
                        </li>
            ...
            <div class="row login-register">
                <div class="col-lg-5">
                            ...
                            <form class="form" method="post" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <input type="password" class="form-control border-0 shadow-none fs-13" id="password-2" name="password" placeholder="Password">
                    ...
                    <div class="media rounded-lg bg-gray-01 p-6 mb-6 mb-lg-0">
                        ...
                        <div class="media-body">
                            <p class="fs-13 text-heading lh-2 mb-0">You can use the credentials that was provided by the developer:</p>
                ...
                <div class="col-lg-7">
                    <div class="card border-0">
                        <img src="{{ asset('web/images/login.png') }}">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row no-gutters mx-n2">
                            ...
                            <div class="col-4 px-2 mb-4">
                                <a href="#" class="btn btn-lg btn-block google px-0">
                                    <img src="{{asset('web/images/google.png')}}" alt="Google">
                                </a>
                            </div>
                            <div class="col-4 px-2 mb-4">
