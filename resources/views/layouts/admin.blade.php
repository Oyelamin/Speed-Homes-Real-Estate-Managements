...
<head>
    ...
    <meta name="twitter:title" content="Add new property">
    <meta name="twitter:description" content="Real Estate">
    <meta name="twitter:image" content="images/homeid-social-logo.png">

    <meta property="og:url" content="dashboard-add-new-property.html">
    <meta property="og:title" content="Add new property">
                ...
                <div class="sticky-area shadow-xs-1 py-3">
                    <div class="d-flex px-3 px-xl-6 w-100">
                        <a class="navbar-brand" href="">
                            <img src="{{asset('web/images/logo.png')}}" alt="HomeID"> Speed Homes
                        </a>
                            ...
                            <div class="d-flex align-items-center d-xl-none">
                                <div class="dropdown px-3">
                                    <a href="#" class="dropdown-toggle d-flex align-items-center text-heading" data-toggle="dropdown">
                                        <div class="w-48px">
                                            <img src="{{asset('web/images/avatar.png')}}" alt="Avatar" class="rounded-circle">
                                        </div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="#"  onclick="$('#logoutForm').submit();">Logout</a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="primaryMenuSidebar">
                        ...
                        <ul class="list-group list-group-flush w-100">
                            <li class="list-group-item pt-6 pb-4">
                                ...
                                <ul class="list-group list-group-no-border rounded-lg">
                                    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                        <a href="{{ route('dashboard') }}" class="text-heading lh-1 sidebar-link">
                            ...
                            <li class="list-group-item pt-6 pb-4">
                                ...
                                <ul class="list-group list-group-no-border rounded-lg">
                                    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                        <a href="{{ route('admin.property.add') }}" class="text-heading lh-1 sidebar-link">
<span class="sidebar-item-icon d-inline-block mr-3 text-muted fs-20 fs-20">
<svg class="icon icon-add-new"><use xlink:href="#icon-add-new"></use></svg></span>
                                            <span class="sidebar-item-text">Add new</span>
                                        </a>
                                    </li>
                                    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                        <a href="{{ route('admin.properties') }}" class="text-heading lh-1 sidebar-link d-flex align-items-center">
...
<svg class="icon icon-my-properties"><use xlink:href="#icon-my-properties"></use></svg>
                                    ...
                                    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                        <a href="{{ route('contact.lists') }}" class="text-heading lh-1 sidebar-link d-flex align-items-center">
<span class="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
<svg class="icon icon-review"><use xlink:href="#icon-review"></use></svg>
                            ...
                            <li class="list-group-item pt-6 pb-4">
                                ...
                                <ul class="list-group list-group-no-border rounded-lg">
                                    ...
                                    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                        <a href="javascript:void(0);"  onclick="$('#logoutForm').submit();" class="text-heading lh-1 sidebar-link">
                                            <span class="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
...
<script>
    ...
    function processInputRequests()
    {
        ...
        var uploader = $('.input-fields:last');
        var images = $('.images');
        ...
        reader.onload = function(event) {
            ...
            images.prepend('<div class="img" style="background-image: url(\'' + event.target.result + '\');" rel="'+ event.target.result  +'">' +
                '<span>remove</span></div>');
        };
        // console.log(uploader[0].files);
        images.append(' <input onchange="processInputRequests()" class="input-fields" type="file" name="uploads[]" hidden>');
