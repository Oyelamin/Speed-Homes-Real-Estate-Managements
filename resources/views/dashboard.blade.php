...
<head>
    ...
    <title>Dashboard - SpeedHomes</title>
                ...
                <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                    <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                        <div class="mr-0 mr-md-auto">
                            ...
                            <p>You can view and add new properties to attract more clients.</p>
                        </div>
                        <div>
                            <a href="{{ route('admin.property.add') }}" class="btn btn-primary btn-lg">
...
<use xlink:href="#icon-1"></use>
                                    ...
                                    <div class="col-7 text-center">
                                        <p class="fs-42 lh-12 mb-0 counterup" data-start="0" data-end="{{ $properties->count() }}" data-decimals="0" data-duration="0" data-separator="">{{ $properties->count() }}</p>
                                        <p>Properties</p>
                                    </div>
                                </div>
                            </div>
...
<svg class="icon icon-2"><use xlink:href="#icon-2"></use></svg>
                        ...
                        <div class="col-sm-8 col-xxl-5 mb-6">
                            <div class="card">
                                <div class="card-body row align-items-center px-6 py-7">
                                    <div class="col-4">
                                            ...
                                            <td class="align-middle pt-6 pb-4 px-6">
                                                <div class="media">
                                                    <div class="w-120px mr-4 position-relative">
                                                        <a href="{{ route('property.view', ['property' => $property->id]) }}">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="{{ route('property.view', ['property' => $property->id]) }}" class="text-dark hover-primary">
